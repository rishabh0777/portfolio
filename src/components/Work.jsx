        ...
        <div className='md:w-[95vw mx-auto mt-8 border-t-[0.1vh] border-zinc-400'>
            {
                works.map((work, index) => (
                    <div key={index} className='flex items-center justify-between w-full py-4 px-4 border-b-[0.1vh] border-zinc-400 hover:bg-[#caf291] hover:text-black cursor-pointer transition-all duration-300'>
